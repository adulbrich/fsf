...
<div class = "flex-1 ml-[16%]">
  ...
  <div class="flex items-center justify-center mr-[20%] mt-[2%]">
    <p class = "flex event-word mb-1 ml-1">Events</p>
    ...
    <svg class = "ml-6" width="100" height="50" viewBox="0 0 140 45" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="flex flex-row h-[85%] w-[90%] ml-[5%] mt-[0.5%]">
    ...
    <div class = "flex flex-col h-[100%] w-[50%]  ml-[0%]">
      ...
      <!-- Past Events -->
      <div class = "flex flex-col w-[90%] h-[30%]  ml-[5.9%] mt-7">
        <!-- Ongoing events Label above card -->
        <p class = "inline-block max-w-full  px-0 py-4" style="font-size: 18px; font-weight:628;">Past Events</p>
        <!-- Card container -->
        <div class="flex flex-row h-[80%] w-[100%] drop-shadow-xl flex-grow-0">
          <!-- Image for card -->
          <div class = "w-[40%] h-[100%] flex-shrink-0">
    ...
    <!-- <div class="flex flex-col w-[50%] h-[100%] border-black border">
      
      <div class = "flex flex-col w-[80%] h-[35%] border-black border ml-[5.9%]" id="ongoing-events">
        <p class = "inline-block max-w-full border-black border p-1">Ongoing Events</p>
